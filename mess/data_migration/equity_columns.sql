...
alter table membership_account add column "shared_address" boolean NOT NULL DEFAULT FALSE;
alter table accounting_transaction add column "is4c_timestamp" timestamp with time zone; 
